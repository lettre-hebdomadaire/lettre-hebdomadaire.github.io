...
function help() {
    show_help = !show_help;
    if(show_help) {
        document.getElementById('help').innerHTML = 'I manage like a big boy/girl &#128526;';
...
function help_2() {
    alert("The image needs to be rearranged by moving the tiles. The general method is to rearrange the tiles in order, row by row, for the first two rows, then column by column for the last two, all in reading order. If you still can't do it, search on the internet, I'm too lazy to explain more.");
}